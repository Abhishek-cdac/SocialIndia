		...
		(
				...
				function($) {
					...
					Typeahead.prototype = {
						...
						render : function(items) {
							...
							if (this.autoSelect && !activeFound) {
								items.filter(":not(.dropdown-header)").first()
										.addClass("active");
					...
					$.fn.typeahead.defaults = {
						source : [],
						items : 8,
						menu : '<ul class="typeahead dropdown-menu" role="listbox" style="position: absolute;width: 95.8%;"></ul>',
