				...
				<div class="container">
					<div class="row">
						<div class="col s12 m12 l12">
							<h5 class="breadcrumbs-title"><s:text name="Breadcrumb.util.disputetolabor" /></h5>
						...
						<table id="example" class="responsive-table display hoverable" cellspacing="0" width="100%">
							<thead>
								<tr class="<s:text name="datatable.heading.bgcolor"/>">
													...
													<th><s:text name="text.laborname"></s:text></th>
					...
					.DataTable(
							{
								...
								"serverSide" : true,
								"displayLength" : 10,
								"ajaxSource" : "disputeToLaborTbldata",
								"sorting" : [],
...
function closecompliant(id){
			...
			swal({   title: "Close Reason",   
		        ...
		        function(inputValue){  
					...
					$("#delgroupform").attr("action", "closetolaborcmpltaction");
					$("#delgroupform").submit();
		...
		swal({    title: "Are you sure?",
            ...
            function(){ 
				...
				$("#delgroupform").attr("action", "deletetolaborcmpltaction");
				$("#delgroupform").submit();
