						...
						<div class="row">
				            ...
				            <div class="row">
				              <div class="col s12 m12 l12">
				                ...
				                <a href="biometricdatabasemenu"><button type="button" class="btn">Biometric Database</button></a>
				                <a href="biometricdatamenu"><button type="button">Biometric Data</button></a>
