...
<body>
	...
	<div id="main">
		...
		<div class="wrapper">
						...
						<div class="row">
							<div class="col s12 m12 l12">
								<h5 class="breadcrumbs-title">
									<s:text name="Text.Audit.Trial" />
								</h5>
								<ol class="breadcrumbs left">
									<li><a href="loginform"><s:text name="Dashboard" /></a></li>
									<li><a href="#"><s:text name="Text.Report.Management" /></a></li>
									<li class="active"><s:text name="Text.Audit.Trial" /></li>

								</ol>
								<div class="right" id="xlspdfdownload">
									<a
										onclick="getencriptedData('<s:text name="socialindia.auditTrialReportXLS"/>');">
										...
										onclick="getencriptedData('<s:text name="socialindia.auditTrialReportPDF"/>');">
										<button id="addaccountbuttonid"
			...
			<div class="col s12 m4 l3">
				<div class="row" style="margin-left: 12px;">
					<div class="input-field col s2">
						...
						<s:textfield name="dateFrom" id="dateFromid"
							cssClass="dateOfBirth" onkeyup="textValidate(this,'20','DT')" />
					</div>
					<div class="input-field col s2">
					...
					<s:if
						test="(#session.sSoctyId!=null && #session.sSoctyId !='' && #session.sSoctyId!='-1')">
			...
			<div id="table-datatables" style="margin: 10px;">
				<div class="row">
						...
						<table id="example" class="responsive-table display hoverable"
							...
							<thead>
								<tr class="<s:text name="datatable.heading.bgcolor"/>">
									...
									<th><s:text name="Text.Operations"></s:text></th>
									<th><s:text name="Text.user.name"></s:text></th>
									<!-- <th><s:text name="Text.Log.Code"></s:text> </th> -->
									<th><s:text name="text.entryDateTime"></s:text></th>
									<th><s:text name="text.modifyDateTime"></s:text></th>
								</tr>
							</thead>
						</table>
					</div>
	...
	<script type="text/javascript">
		...
		function townshipdata(valjson) {
			...
			$('#township_txt_id').typeahead({
				...
				updater : function(item) {
					console.log("item in audit trail :["+item+"]")
			...
			oTable = $('#example').DataTable(
					{
						...
						"serverSide" : true,
						"displayLength" : 10,
						"ajaxSource" : "auditTrialReportTbldata?fromdate="
								+ fromdate + "&todate=" + todate + "&sSoctyId="
								+ sSoctyId + "&sTowshipId=" + sTowshipId,
						"sorting" : [],
		...
		function getencriptedData(purl) {
			...
			$
					.ajax({
						...
						data : 'fromdate=' + fromdate + '&todate=' + todate
								+ "&sSoctyId=" + sSoctyId + "&sTowshipId="
								+ sTowshipId,
						success : function(pdata) {
							var lcurl = purl + "?" + pdata;
							//window.location.href = lcurl;
							document.getElementById('my_iframe').src = lcurl;
