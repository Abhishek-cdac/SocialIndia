				...
				<div class="container">
					<div class="row">
						<div class="col s12 m12 l12">
							<h5 class="breadcrumbs-title"><s:text name="Text.report.resident" /></h5>
							<ol class="breadcrumbs left">
								<li><a href="loginform"><s:text name="Dashboard" /></a></li>
								<li><a href="#"><s:text name="Text.Report.Management" /></a></li>
								<li class="active"><s:text name="Text.report.resident" /></li>

							</ol>
							<div class="right" id="xlspdfdownload">
							<a
							onclick="getencriptedData('<s:text name="socialindia.residentReportXLS"/>');">
							<button id="addaccountbuttonid" class="<s:text name="button.color.new.create"/>"
								...
								<a
									onclick="getencriptedData('<s:text name="socialindia.residentReportPDF"/>');">
			...
			oTable = $('#example').DataTable(
							{
								...
								"serverSide" : true,
								"displayLength" : 10,
								"ajaxSource" : "residentmgmtReportTbldata?fromdate="
			...
			if(fromdate!='' && todate!=''){
			    ...
			    if (fromdatebj  <= toDateobj) {			    	  			    	   
					...
					oTable = $('#example').DataTable( {
								...
								"serverSide" : true,
								"displayLength" : 10,
								"ajaxSource" : "residentmgmtReportTbldata?fromdate="+ fromdate + "&todate=" + todate+"&sSoctyId="+sSoctyId+"&sTowshipId="+sTowshipId,
								"sorting" : [],
								"paginationType" : "full_numbers",
								"columnDefs" : [ {
									"sortable" : false,
