				...
				<div class="container">
					<div class="row">
						<div class="col s12 m12 l12">
							<h5 class="breadcrumbs-title"><s:text name="Text.report.merchant" /></h5>
							<ol class="breadcrumbs left">
								<li><a href="loginform"><s:text name="Dashboard" /></a></li>
								<li><a href="#"><s:text name="Text.Report.Management" /></a></li>
								<li class="active"><s:text name="Text.report.merchant" /></li>

							</ol>
							<div class="right" id="xlspdfdownload">
							<a onclick="getencriptedData('<s:text name="socialindia.merchantReportXLS"/>');">
							<button id="addaccountbuttonid" class="<s:text name="button.color.new.create"/>"
								...
								<a onclick="getencriptedData('<s:text name="socialindia.merchantReportPDF"/>');">
			...
			<div class="col s12 m4 l3">
				<div class="row" style="margin-left: 12px;">
					<div class="input-field col s2">
						...
						<s:textfield name="dateFrom" id="dateFromid" cssClass="dateOfBirth" onkeyup="textValidate(this,'20','DT')" />
					</div>
					<div class="input-field col s2">
						<label for="dateToid">To Date [dd-mm-yyyy]</label>
						<s:textfield name="dateTo" id="dateToid" cssClass="dateOfBirth" onkeyup="textValidate(this,'20','DT')" />
	...
	$(document).ready(function() {			
		...
		function createoTable() {
			...
			oTable = $('#example').DataTable({
								...
								"serverSide" : true,
								"displayLength" : 10,
								"ajaxSource" : "merchantmgmtReportTbldata?fromdate=" + fromdate + "&todate=" + todate,
								"sorting" : [],
