          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><s:text name="Text.add.facility"/></h5>
                <ol class="breadcrumbs left">
                   <li><a href="posthomepage"><s:text name="Text.Home" /></a></li>
                    ...
                    <li class="active"><s:text name="Text.add.facility" /></li>
                   </ol>
              </div>
            </div>
          </div>
...
<div class="card-panel">
	<form id="newfacilityFormId" name="newfacilityFormId" action="newfacility" method="post" enctype="multipart/form-data"  >
		<div class="row">
			<div class="col s12 m4 l3">
				<input type="file" name="facImage" id="facImage" class="dropify" data-default-file="" />
        	</div>
		...
		<div class="row">
  			...
  			<div class="input-field col s6">
				...
				<s:textfield  id="societyId_txt_id" name="societyName"  cssClass="typeahead tt-query form-control left" autocomplete="off" />
        ...
        <div class="row margin" >
			<div class="input-field col s12">
				...
				<textarea class="materialize-textarea validate" name="facdesc" id="facdesc" rows="2" style="resize:none;height:15px"></textarea>
			</div>
		</div>

		<div class="row" style="margin-left:10px;" >
				<button type="submit" id="createfacility" class="<s:text name="button.color.submit"/>" onclick="createfacilitymethod();">
...
<script>
function createfacilitymethod(){
	$('#newfacilityFormId').attr("method","post");
	$('#newfacilityFormId').attr("action","newfacility");
	$('#newfacilityFormId').attr("enctype","multipart/form-data");
	$('#newfacilityFormId').submit();
}
