	...
	<div id="main">
		...
		<div class="wrapper">
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
								<h5 class="breadcrumbs-title"> Tender Modify</h5>
							...
							<li><a href="tendermgmt"><s:text name="Tender" /></a></li>
									<li class="active"> Tender Modify</li>
								</ol>
							</div>
						</div>
					</div>
			...
			<div class="card-panel">
				<form method="post" id="formValidate" name="formValidate" enctype="multipart/form-data" action="tenderUpdateAction">
 						<div class="row rowmargin12px" >
						<div class="input-field col s6">
						<label for="lastname" class="active"><s:text name="Text.tendername" /><span class="mandatory">*</span></label>
						<s:textfield name="tenderobj.tenderName" id="lastname" cssClass="form-control topicname titlevalidate" />
						</div>
															
					<div class="input-field col s6">
					<label for="datePicker" class="active">Tender Date<span class="mandatory">*</span></label> 																														
					<s:textfield  cssClass="futuredateOfBirth" name="tenderobj.tenderDate" id="datePicker"></s:textfield>
												</div></div>
												
														<div class="row rowmargin12px" >
										              <div class="input-field col s12">
										              <label for="textarea1" class="active"><s:text name="Text.tenderdail" /><span class="mandatory">*</span></label>
											<s:textarea name="tenderobj.tenderDetails" id="textarea1" cssClass="form-control materialize-textarea tenderdescvalidate"/> 
									<%-- <label for="textarea1"><s:text name="Text.tenderdail" /><span class="mandatory">*</span></label>
									<textarea id="textarea1" name="tenderobj.tenderDetails" class="materialize-textarea tenderdescvalidate "></textarea> --%>
								</div>
									</div>	
							...
							<div id="documentfile-error" class="error manualscriptvalidation" style="display: none;">Actual Price Is Required</div>
						       ...
						       <button type="submit" id="userCreateButtonId"  class="<s:text name="button.color.submit"/>"> <s:text name="Text.button.update" /> <i class="<s:text name="button.icon.submitcard"/>"></i> </button>
						       <button type="button" id="userCancelButtonId" class="<s:text name="button.color.cancel"/>" onclick="cancelFunction();"><s:text name="Text.button.cancel" /> <i class="<s:text name="button.icon.replycard"/>"></i> </button>
				                                  	...
				                                  	<s:hidden id="tenderid" name="tenderobj.tenderId" ></s:hidden>
														</form> 
										</div>
...
$(document).ready(function(){
	 $('input[type=file]').drop_uploader({
	        uploader_text: 'Drop files or Images to upload, or',
	        browse_text: 'Browse',
...
/* $(document).ready(function() {
     ...
     .on('changeDate', function(e) {        	
         $('#userCreationFormId').formValidation('revalidateField', 'evestartdate');
     }); 
     ...
     .on('changeDate', function(e) {        	
         $('#userCreationFormId').formValidation('revalidateField', 'eveenddate');
     }); 
