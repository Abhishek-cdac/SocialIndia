			...
			swal({
				...
				$.ajax({
					...
					success : function(data) {
						...
						$("#feedid_" + id).attr("onclick", "activeactioncontent('" + id + "','"+tblflag+"')");
						$("#feedcnt_lbl_" + id).html("&nbsp;&nbsp;UnBlock Content");
					...
					$("#feedid_" + id).prop('checked',false).change();
					$("#feedcnt_lbl_" + id).html("&nbsp;&nbsp;Block Content");
				}
			});
		}	
	 function activeactioncontent(id, tblflag) {
			...
			swal({
				...
				$.ajax({
					...
					data : 'uniqueId=' + id + '&tableflg=' + tblflag+'&blockrowid='+id,
					success : function(data) {
						$("#feedid_" + id).attr("onclick", "deleteactioncontent('" + id + "','"+tblflag+"')");
						$("#feedcnt_lbl_" + id).html("&nbsp;&nbsp;Block Content");
						swal(statusval + "!", "Record has been " + statusval + ".", "success");
					},
					error : function(d) {
						...
						swal(statusval + "!", "Record has not been " + statusval + ".", "error");
					 	...
					 	$("#feedid_" + id).prop('checked',true).change();
						$("#feedcnt_lbl_" + id).html("&nbsp;&nbsp;UnBlock Content");
					 }
			});
		}
