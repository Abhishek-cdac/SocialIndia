...
<body>
				...
				<div class="container">
					<div class="row">
						<div class="col s12 m12 l12">
							<h5 class="breadcrumbs-title"><s:text name="Breadcrumb.util.disputetoadmin" /></h5>
							<ol class="breadcrumbs left">
								...
								<li class="active"><s:text name="Breadcrumb.util.disputetoadmin" /></li>

							</ol>
				<s:if test="#session.GROUPCODE==5 || #session.GROUPCODE.equalsIgnoreCase('5') || #session.GROUPCODE==4 ||#session.GROUPCODE.equalsIgnoreCase('4')" >
					<div class="right">
                      <a href="rootusercreatecomplaint"><button class="<s:text name="button.color.new.create"/> " data-tooltip=" Create New Compliant" data-delay="10" data-position="bottom" style="width: 228px;" type="button" data-tooltip-id="bf9615fd-0551-45fd-61bb-34647624e5d6"><i class="mdi-social-domain  left"> </i><s:text name="text.newcomplaint"/></button></a>
                </div>	
                </s:if>
						</div>
						...
						<table id="example" class="responsive-table display hoverable" cellspacing="0" width="100%">
							<thead>
									<tr class="<s:text name="datatable.heading.bgcolor"/>">
													...
													<th><s:text name="text.adminname"></s:text></th>
	...
	<s:form method="post" id="delgroupform">
			...
			<s:form method="post" id="smssendform">
					
					<s:hidden name="smscommentfield" id="smscommentid"></s:hidden>
					<s:hidden name="uniqueId" id="deleteusridEdit"></s:hidden>
			</s:form>
	...
	$(document).ready(function() {
					...
					.DataTable(
							{
								...
								"serverSide" : true,
								"displayLength" : 10,
								"ajaxSource" : "disputeToAdminTbldata",
								"sorting" : [],
		...
		function closecompliant(id){
			...
			swal({   title: "Close Reason",   
		        ...
		        function(inputValue){  
					...
					$("#delgroupform").attr("action", "closecmpltaction");
					$("#delgroupform").submit();
		...
		swal({    title: "Are you sure want to delete?",
          text: "You will not be able to recover this social admin compliant!",   
            type: "warning",   
            ...
            function(){ 
				...
				$("#delgroupform").attr("action", "deletecmpltaction");
				$("#delgroupform").submit();
