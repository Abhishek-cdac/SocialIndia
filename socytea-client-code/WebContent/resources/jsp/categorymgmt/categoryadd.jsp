          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><s:text name="text.create.Category"/></h5>
                <ol class="breadcrumbs left">
                   <li><a href="posthomepage"><s:text name="Text.Home" /></a></li>
									...
									<li class="active"><s:text name="text.create.Category" /></li>  
                   </ol>                              						
              </div>              
            </div>            
          </div>          
       	...
       	<div class="card-panel">
										<form  id="categoryCreationFormId" name="categoryCreationFormId" action="categorymgmtadd" method="post" enctype="multipart/form-data" >
										    <div id="">										 
						...
						<div class="row">	
								<div class="input-field col s12">
										...
										<label class="active" for="staffImage"><s:text name="Text.category.image"/></label>	
...
$(document).ready(function(){
   ...
   $('.dropify').dropify({
    ...
    drEvent.on('dropify.afterClear', function(event, element){
    	...
    	$('#categoryCreationFormId').validate({
    		 errorElement : 'div',
