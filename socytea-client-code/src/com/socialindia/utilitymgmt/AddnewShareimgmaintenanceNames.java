...
public class AddnewShareimgmaintenanceNames  extends ActionSupport implements Serializable{
	...
	public String execute(){
		try{
			...
			String finalUrl = getText("socialindia.utility.addShareimgmaintenanceNames");
		 ...
		 if(statusCode.equalsIgnoreCase("0")){
				...
				alert.setCls("danger");
				alert.setMsg(getText("Maintenance.Document.share.error"));
				alertList.add(alert);
				return "input";
			}
