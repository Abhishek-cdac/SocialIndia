...
public class labor_merchantSMSSend extends ActionSupport{
	 private Common commonObj = new CommonDao();
	 private int uniqcmpltid;
	 private String complaintfrmmobno;
	 ...
	 JSONObject obj = new JSONObject();
	  ...
	  JSONObject locObjRecvJson = null;//Receive String to json	
    	...
    	data.put("servicecode", "SI9008");
		obj.put("uniqcmpltid", uniqcmpltid);
		obj.put("complaintfrmmobno", complaintfrmmobno);
	...
	//	toCheckService(postparam+URLEncoder.encode(postparamval),srvcUrl);
		...
		String finalUrl_pcode = getText("socialindia.complaintmgmt.send.sms.action");
...
public String getComplaintfrmmobno() {
	return complaintfrmmobno;
}
public void setComplaintfrmmobno(String complaintfrmmobno) {
	this.complaintfrmmobno = complaintfrmmobno;
}
