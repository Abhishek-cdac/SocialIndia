...
public class DoctypMasterTblVO implements Serializable {
	...
	public DoctypMasterTblVO(Integer doccnfgid, String doccnfgName,
			Integer doccnfgstatus) {
		this.ivrBnDOC_TYP_ID=doccnfgid;
		this.ivrBnDOC_TYP_NAME=doccnfgName;
		this.ivrBnACT_STS=doccnfgstatus;
