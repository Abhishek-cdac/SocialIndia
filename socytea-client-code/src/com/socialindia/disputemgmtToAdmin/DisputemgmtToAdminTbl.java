...
public class DisputemgmtToAdminTbl extends ActionSupport implements
...
ServletContextAware{
	private static final long serialVersionUID = 1L;
	  ...
	  public String execute() {
		  Log logwrite = null;
	    try {
	    	System.out.println("DisputemgmtToAdminTbl  loading.......");
	    	logwrite = new Log();
	      ...
	      try {	 
			...
			dataJson.put("currentloginid", String.valueOf(sessionMap.get("USERID")));
	  		...
	  		finaljj.put("servicecode", "SI32000");		
	  		finaljj.put("data", dataJson);	     
	        String jsonTextFinal = finaljj.toString();
	        jsonTextFinal=EncDecrypt.encrypt(jsonTextFinal);
			String temp="ivrparams="+ URLEncoder.encode(jsonTextFinal);			
			String finalUrl =getText("socialindia.disputemgmt.toadmindatable");			
			String response=commonObj.jsonRequest(finalUrl, temp);
			JSONObject json = new JSONObject(response);
			JSONObject json_data=json.getJSONObject("data");
			 total =  json_data.getInt("InitCount");
			 ar = json_data.getJSONArray("disputeadmindetails");
			 JSONObject jsonList = new JSONObject();
			 String disp_sctyname=null,disp_twnshpname=null,disp_desc=null,disp_title=null,disp_id=null,disp_toid=null,disp_usrname=null,disp_toadminname=null;
			 Integer disp_adminid;
			  JSONArray ja;
			  String uniId = "";
			 ...
			 for(int i=0;i<ar.length();i++)
				{	
					...
					disp_id = (String) Commonutility.toHasChkJsonRtnValObj(jsonList, "disp_id");
					disp_toid=(String) Commonutility.toHasChkJsonRtnValObj(jsonList, "disp_toid");
					disp_toadminname=(String) Commonutility.toHasChkJsonRtnValObj(jsonList, "disp_tosocialadminname");
					...
					disp_title=(String) Commonutility.toHasChkJsonRtnValObj(jsonList, "disp_title");
					...
					if(String.valueOf(sessionMap.get("GROUPCODE")).equalsIgnoreCase("5"))
					{
					 action +="<div class=\"divactionicon\">"
					 		+ "<a style=\"cursor: pointer;\"   href=\"Admincomplaintview?uniqueId="+disp_id+"\" >"
					 ...
					 action +="<div onclick=\"compliantsendemail("+disp_id+");\"  class=\"divactionicon\" >"
					 ...
					 action +="<div onclick=\"sendsmstoadmin("+disp_id+");\" class=\"divactionicon\">"
	        ...
	        System.out.println("Step -1 : Exception Found : "+ex);
	    	  logwrite.logMessage("Step -1 : Exception Found : "+ex, "error", DisputemgmtToAdminTbl.class);
	      }
	      finally{
	      ...
	      System.out.println("Step 3 : Worktype MasterDTable Manage Table [End]"+new SimpleDateFormat("yyyy-MM-dd hh:mm:SSS").format(new Date()));
	 	  logwrite.logMessage("Step 3 : Worktype MasterDTable Table [End] ", "info", DisputemgmtToAdminTbl.class);
	      getResponse();
	     

	    } catch (Exception ex) {
	    	System.out.println("Step -1 4: Exception Found : "+ex);
	  	  	logwrite.logMessage("Step -1 4: Exception Found : "+ex, "error", DisputemgmtToAdminTbl.class);
	    }
	    finally{
	    	logwrite = null;
	    }
