...
public class SocietyMgmtReportDataTbl extends ActionSupport implements
	      ...
	      if (sdtSortDir0 != null) {
			...
			try {   
				...
				if (sdtSearchff != null) {
		  		...
		  		finaljj.put("servicecode", "SI6428");		
		  		finaljj.put("data", dataJson);	     
		        String jsonTextFinal = finaljj.toString();
		        jsonTextFinal=EncDecrypt.encrypt(jsonTextFinal);
				String temp="ivrparams="+ URLEncoder.encode(jsonTextFinal);			
				String finalUrl =getText("socialindia.societyreportMng.loadDataTable");				
				...
				String lvrSocietyname= null, lvrTownshipName=null, lvrSocietyuniquid=null,lvrTownshipuniquid=null, lvrSocietyactikey=null,userName="",dob=null,emailId =null,mobileNo=null,countryName=null,stateName=null,cityName="",entryDatetime="",modifyDatetime="",lastName=null,firstName=null;
				...
				for (int i = 0; i < ar.length(); i++) {			
					...
					lvrSocietyuniquid=(String) Commonutility.toHasChkJsonRtnValObj(jsonList, "societyuniqid");
					lvrTownshipuniquid=(String) Commonutility.toHasChkJsonRtnValObj(jsonList, "townshipuniqid");
					lvrSocietyactikey=(String) Commonutility.toHasChkJsonRtnValObj(jsonList, "societyactivationkey");
					...
					ja.put(lvrSocietyuniquid);
					ja.put(lvrSocietyactikey);
					ja.put(mobileNo);
					ja.put(countryName);
					ja.put(stateName);
					ja.put(cityName);
	        ...
	        System.out.println("Exception found in SocietyMgmtReportDataTbl.class : " + ex);
	      } finally {
