...
public class MerchantmgmtreportDataTbl  extends ActionSupport implements
	    ...
	    try {
	      ...
	      try {	       
			...
			if(sdtSearchff!=null){
	  		...
	  		finaljj.put("servicecode", "SI6426");		
	  		finaljj.put("data", dataJson);	     
	        String jsonTextFinal = finaljj.toString();
	        jsonTextFinal=EncDecrypt.encrypt(jsonTextFinal);
			String temp="ivrparams="+ URLEncoder.encode(jsonTextFinal);			
			String finalUrl =getText("socialindia.mrchantMng.merchantReportTable");
			...
			String mrchntEmail =null,shopName=null,mrchntPhNo=null,countryName=null,stateName=null,mrchntName="",cityName="",mrchCategoryName="",entryDatetime="",modifyDatetime="";
			int mrchntId=0;
			for(int i=0;i<ar.length();i++){	
				...
				merchantobj.setEntryDatetime(entryDatetime);
				merchantobj.setModifyDatetime(modifyDatetime);
	        ...
	        try {
	          ...
	          for (Iterator<MerchantTblVO> it = merchantList.iterator(); it.hasNext();) {
	           ...
	           /* ja.put(userObj.getCountryName());
	            ...
	            ja.put(userObj.getEntryDatetime());
	           // ja.put(userObj.getModifyDatetime());
	            array.put(ja);
	          }
	        } catch (Exception ex) {
	          ex.printStackTrace();
