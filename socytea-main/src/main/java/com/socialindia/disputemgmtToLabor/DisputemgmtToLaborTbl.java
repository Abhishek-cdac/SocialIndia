...
import com.socialindia.disputemgmtToMerchant.DisputemgmtTomerchantTbl;
import com.socialindia.generalmgnt.persistance.Commonutility;
import com.socialindia.login.EncDecrypt;
import com.socialindia.townShipMgmt.townShipMgmtTable;

public class DisputemgmtToLaborTbl extends ActionSupport implements
...
ServletContextAware{
	private static final long serialVersionUID = 1L;
	  ...
	  public String execute() {
		  Log logwrite = null;
	    try {
	    	System.out.println("DisputemgmtToLaborTbl  loading.......");
	    	logwrite = new Log();
	      ...
	      try {
				...
				dataJson.put("grpcode", "labour_report");//7-labor 8-merchant
		  		JSONObject finaljj=new JSONObject();
		  		finaljj.put("servicecode", "SI31000");
				...
				for (int i = 0; i < ar.length(); i++) {
					...
					if(String.valueOf(sessionMap.get("GROUPCODE")).equalsIgnoreCase("5")) {
					 action +="<div class=\"divactionicon\">"
						 		+ "<a style=\"cursor: pointer;\"   href=\"Labordisputeview?uniqueId="+disp_id+"\" >"
		            ...
		            disp_tomerchantname = "<a class=\"pointer tooltipped\" data-tooltip=\"Click to View\" data-delay=\""+getText("material.tooltip.delay")+"\" data-position=\"bottom\" target=\"_blank\" href=\"viewlbrfeedbck?deletelaborid="+disp_toid+"\">"+disp_tomerchantname+"</a>";
		            ja.put(sno);
