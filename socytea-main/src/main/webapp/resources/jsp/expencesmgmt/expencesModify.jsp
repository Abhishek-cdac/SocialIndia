	...
	<div id="main">
		...
		<div class="wrapper">
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
								<h5 class="breadcrumbs-title"><s:text name="Breadcrumb.util.Management.modifyexpense"/></h5>
								<ol class="breadcrumbs left">
									...
									<li class="active"><s:text name="Breadcrumb.util.Management.modifyexpense"/></li>
								</ol>
							</div>
						</div>
					</div>
			...
			<div class="card-panel">
				<form method="post" id="registerformid" name="registerformid" enctype="multipart/form-data" action="expencesUpdateAction">
 													<div class="row rowmargin12px" >
										                <div class="input-field col s6">
																<label><s:text name="Text.expences" /><span class="mandatory">*</span></label>
																<s:textfield name="expenceobj.expenceFor" id="expences" cssClass="form-control topicname expencesvalidate" />
															
															</div>
															<div class="input-field col s6">
																 <label><s:text name="Text.no.prodcut" /><span class="mandatory">*</span></label> 															
															    
															    <s:textfield name="expenceobj.noOfProduct" id="noproducts" cssClass="form-control topicname productvalidate" />   															            											        					
															</div></div>
														<div class="row rowmargin12px" >
										                <div class="input-field col s6">
																 <label><s:text name="Text.amount" /><span class="mandatory">*</span></label> 															
															    
															    <s:textfield name="expenceobj.productPerAmt" id="amount" cssClass="form-control topicname amountvalidate" />
           													  															            											        					
															</div>
															<div class="input-field col s6">
												<label class="control-label"><s:text name="Text.totalamt" /><span class="mandatory">*</span></label>
											<s:textfield name="expenceobj.expenceTotAmt" id="totalamt" cssClass="form-control topicname totalamtvalidate" />										
												...
												<label class=" control-label" for="expenceDesc"><s:text name="Text.desc" /></label>
												<s:textarea id="expenceDesc" name="expenceobj.descr" cssClass=" materialize-textarea form-control custom-control" style="height: 10px;"></s:textarea>   
						                   ...
						                   <div style="margin-left: 0px;">
							                       ...
							                       <i class="<s:text name="button.icon.replycard"/>"></i>
													...
													<s:hidden id="uniqueId" name="expenceobj.expnId" ></s:hidden>
														</form>
														</div>
