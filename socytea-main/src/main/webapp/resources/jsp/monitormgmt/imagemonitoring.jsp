...
<body>
	...
	function createoTable() {
	 ...
	 function deleteactioncontent(id, tblflag) {
		
			var statusval = "";
			statusval = "Block User Image";
			swal({
				...
				$.ajax({
					...
					data : 'uniqueId=' + id + '&tableflg=' + tblflag+'&blockrowid='+id,
					success : function(data) {
					
						$("#imgmontid_" + id).attr("onclick", "activeactioncontent('" + id + "','"+tblflag+"')");
						$("#imgmontcnt_lbl_" + id).html("&nbsp;&nbsp;UnBlock User Image");
	 ...
	 function activeactioncontent(id, tblflag) {
		
			var statusval = "";
			statusval = "Unblock User Image";
			swal({
				title : "Are you sure want to " + statusval + "?",
				...
				$.ajax({
					...
					data : 'uniqueId=' + id + '&tableflg=' + tblflag+'&blockrowid='+id,
					success : function(data) {
						$("#imgmontid_" + id).attr("onclick", "deleteactioncontent('" + id + "','"+tblflag+"')");
						$("#imgmontcnt_lbl_" + id).html("&nbsp;&nbsp;Block Image");
						swal(statusval + "!", "Record has been " + statusval + ".", "success");
					},
					error : function(d) {
						...
						swal(statusval + "!", "Record has not been " + statusval + ".", "error");
					 	...
					 	$("#imgmontid_" + id).prop('checked',true).change();
						$("#imgmontcnt_lbl_" + id).html("&nbsp;&nbsp;UnBlock User Image");
					 }
			});
		}
