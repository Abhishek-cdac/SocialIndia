			...
			<section id="content">
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
	                           ...
	                           <s:text name="Add Why Should I Update" />
	                            </h5>
								<ol class="breadcrumbs left">
									...
									<li class="active"><s:text name="Add Why Should I Update" /></li>
								</ol>
							</div>
						</div>
					</div>
				...
				<div class="container">
					<div class="card-panel">
						<form id="whyshoudFormId" name="whyshoudFormId"
							action="whyshoudcreate" method="post"
							...
							<div class="row">
								<div class="input-field col s12">
									...
									<textarea class="materialize-textarea whydes" name="whydes" id="whydes" rows="2" style="resize: none; height: 50px"></textarea>
								</div>
							</div>
							<div class="row">
								<div class="input-field col s6">
									<button type="button" id="createfacility" class="<s:text name="button.color.submit"/>" onclick="createfacilitymethod();">
...
<script>
	...
	function createfacilitymethod() {
		$('#whyshoudFormId').attr("Method", "Post");
		$('#whyshoudFormId').attr("action", "whyshoudcreate");
		$('#whyshoudFormId').attr("enctype", "multipart/form-data");
		$('#whyshoudFormId').submit();
	}
