		...
		<div class="wrapper">
			...
			<section id="content">
				...
				<div class="container">
                    ...
                    <li>  <a href="gatepasshistory"><s:text name="Breadcrumb.manage.issuegatepasshistory" /></a></li>
                     <li class="active"><s:text name="Breadcrumb.manage.viewgatepass" /></li>
						</ol>
						<div class="right">
									<button id="gobckbtnid"
											class="tooltipped <s:text name="button.color.cancel" />" data-toggle="modal" data-target="#addnewaccount" data-position="bottom" data-delay="<s:text name="material.tooltip.delay"/>" data-tooltip="Go Back" type="submit" name="action">
...
$(document).ready(function(){
	$("#gobckbtnid").click(function(){
		...
		$("#userCancelForm").attr("action", "gatepasshistory");
