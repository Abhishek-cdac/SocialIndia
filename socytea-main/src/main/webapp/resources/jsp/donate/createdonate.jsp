		...
		<div class="wrapper">
			...
			<section id="content">
					...
					<div class="container">			
						<div class="row">
							<div class="col s12 m12 l12">
								<h5 class="breadcrumbs-title"><s:text name="Text.CreateCampaign.Management" /></h5>
							...
							<li class="active"><s:text name="Text.CreateCampaign.Management" /></li>
						</ol>
					</div>
				</div>
				</div>
				...
				<div id="jqueryvalidation" class="section">
				 ...
				 <form role="form" id="donation"  method="post" action="" enctype="multipart/form-data">
                             <div class="col m12">
							 ...
							 <div class="row">
								...
								<input type="file" id="maintexcelfile"  name="image" data-maxfilesize="<s:text name="upload.file.size" />"
								class="mrgnleft15 maintexcelfile dropify" style="margin-left: 0px;" />
										<div class ="clear height10px"></div>	
								<div id="maintexcelfile-error" class="error manualscriptvalidation" style="display: none;">Institution Image Need.</div>														
								<div class ="clear height25px"></div>	
								
                         		<button type="button" id="userEditButtonId" onclick="createdonation();" class="<s:text name="button.color.submit"/>"  ><s:text name="Text.button.submit" /><i class="<s:text name="button.icon.submitcard"/>"></i></button>
...
function getsociety_auto(tempdata){
  ...
  //add dynamical validate - 2
	...
	function createdonation() {
			$("#donation").attr("action","createdonateaction");
			$("#donation").submit();
			}
