			...
			<div class="row">
				<div class="col s12 m12 l12">
					...
					<ol class="breadcrumbs left">
						...
						<li class="active">App Rights Mgmt</li>
					</ol>
				</div>
			</div>
		</div>
...
function encDataSet(param){
	...
	$.ajax({
		url : <%=basePath%>+"/socialindiaservices/encryptData",
		type : "post",
...
function updateAccessFlags(param){
	...
	$.ajax({
		url : <%=basePath%>+"/socialindiaservices/appRightsMgmt",
		type : "post",
		data : "ivrparams="+param,
		success : function(data) {
...
$.ajax({
	url : <%=basePath%>+"/socialindiaservices/siSocietymgmt",
	type : "post",
	data : <%= temp %>,
	success : function(data) {
