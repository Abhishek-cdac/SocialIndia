...
<link href="<s:text name='Resource.path'/>/js/plugins/chartist-js/chartist.min.css?dfs" type="text/css" rel="stylesheet" media="screen,projection">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><s:text name="Text.Staff.Modify"/></h5>
                <ol class="breadcrumbs left">
                   <li><a href="posthomepage"><s:text name="Text.Home" /></a></li>
                    ...
                    <li class="active"><s:text name="Text.Staff.Modify" /></li>
                   </ol>
              </div>
            </div>
          </div>
       	...
       	<div class="card-panel">
			<form role="form" id="userCreationFormId" action="staffmanagementEditform" method="post" enctype="multipart/form-data" >
											<div class="row">
									  <div class="col s12 m4 l3">
										    <input type="file" id="documentfile" name="staffImage" class="dropify" data-default-file="/templogo/staff/web/<s:property value="#session.staffSessID"/>/<s:property value="#session.staffProfileImage"/>" />
           									 </div>
                                                    ...
                                                    <div class="row">
                                                       <div class="input-field col s6">
                                                          ...
                                                          <div class="input-field col s1">
                                                                ...
                                                                <s:textfield cssClass="form-control Isdcode"  name="staffRegObj.ISDcode" id="isdcodeid"></s:textfield>
												...
												<s:hidden type="hidden" name="staffRegObj.staffcompany_hidd_txt" id="companyname_hidd_id" class="form-control"/>
            								</div>
                                                     <div class="input-field col s6">
                                                     ...
                                                     <div class="input-field col s12">
                                                      ...
                                                      <div class="row">
                                                         <div class="input-field col s6">
                                                               ...
                                                               <s:textfield  name="staffIdcardtypname" id="card" cssClass="form-control typeahead tt-query idproofvalidate left" autocomplete="off"/>
												...
												<s:hidden name="staffIdcardtypeval" id="cardid" class="form-control"></s:hidden>
                                                        </div>
                                                         <div class="input-field col s6">
                                                    ...
                                                    <div class="row">
                                                    <div class="input-field col s6">
															<label for="gendertype" class="active"><s:text name="Text.gender" /></label>
															<s:select cssClass="form-control gendervalidate" id="gendertype" headerValue="Select Gender" name="staffRegObj.staffGender"  list="#{'1':'Male','2':'Female','3':'Other' }"/>
															</div>
                                                     <%-- <div class="input-field col s6">
                                                                <label for="staffGender"><s:text name="Text.customerreg.gender" /><span class="mandatory"></span></label>
                                                                <s:select id="staffGender" cssClass="form-control gendervalidate" headerValue="Select Gender"
                                                                          list="#{'1':'Male','2':'Female','3':'Other' }"
                                                                         name="staffRegObj.staffGender" >
                                                                </s:select>
                                                            </div> --%>
                                                         <div class="input-field col s6">
                                                                <label for="category">Category<span class="mandatory"></span></label>
                                                                <s:textfield name="staffcateidname" id="category" cssClass="form-control typeahead tt-query category" autocomplete="off"/>
                                                                <span class="input-group-addon txtbxdownarowicon left" onclick="openAutocmp('category');"><i class="mdi-navigation-arrow-drop-down tinysmall black-text"></i></span>
			 													<s:hidden name="Staffcatidval" id="categoryid" class="form-control"> </s:hidden>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                      <div class="input-field col s6">
                                                                <label for="workinghour">Work Hours<span class="mandatory"></span></label>
                                                                <s:textfield name="staffRegObj.wrkhourstr" id="workinghour" cssClass="form-control mobilevalidate"/>
                                                        </div>
                                                         <div class="input-field col s6">
                                                                <label for="address2"><s:text name="Address"></s:text><span class="mandatory"></span></label>
                                                                <s:textfield name="staffRegObj.staffAddr" id="address2"  cssClass="form-control addrvalidate"/>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                       <div class="input-field col s6">
                                                                <label for="country_txt_id"><s:text name="Menuheader.uam.profile.country" /></label>
           																 <s:textfield name="staffCountryname" id="country_txt_id" cssClass="form-control typeahead tt-query left" autocomplete="off" />
												...
												<s:hidden name="staffCountryId" id="country_hidd_id" class="form-control"/>
                                                         ...
                                                         <div class="input-field col s6">
                                                             ...
                                                             <s:textfield name="staffstatename" id="state_txt_id" cssClass="form-control typeahead tt-query left" autocomplete="off"/>
												...
												<s:hidden name="staffStateino" id="state_hidd_id" class="form-control"/>
          														<s:fielderror fieldName="usercreateObj.groupId.groupCode"/>
                                                            </div>
                                                    </div>
                                                    <div class="row">
                                                      <div class="input-field col s6">
                                                                <label for="city_txt_id"><s:text name="Menuheader.uam.profile.city" /></label>
                                                               	<s:textfield name="staffCityname" id="city_txt_id" cssClass="form-control typeahead tt-query left" autocomplete="off"/>
												...
												<s:hidden name="staffcityno" id="city_hidd_id" class="form-control"/>
                                                                <s:fielderror fieldName="usercreateObj.groupId.groupCode"/>
                                                        </div>
                                                        <div class="input-field col s6">
                                                                <label for="pstlcode_txt_id"><s:text name="Text.customerreg.pincode" /></label>
                                                                <s:textfield name="staffpinno" id="pstlcode_txt_id" cssClass="form-control typeahead tt-query left" autocomplete="off"/>
...
<%-- 												<s:hidden name="staffpinno" id="pstlcode_hidd_id" class="form-control"/> --%>
                                                        </div>
                                                    </div>	</div>
                                                    <s:hidden name="StaffuniqueId" id="uniqStaffIdEdit"></s:hidden>
                                                     <%-- <s:textfield name="stateData.stateId" id="iVOstaffcategid" value="%{stateData.stateId}"/> 	 --%>
                       <div class="input-field col s6">
...
// 	 onchangePstlcodeAgency();
	/*$("#country_txt_id").change(function(){
		 onchangeStatecodeAgency();
	});
	$("#state_txt_id").change(function(){
		onchangeCitycodeAgency();
	});
	$("#city_txt_id").change(function(){
		onchangePstlcodeAgency();
	});*/
