				...
				<div class="container">
					<div class="row">
						<div class="col s12 m12 l12">
							<h5 class="breadcrumbs-title"><s:text name="Text.report.society" /></h5>
							<ol class="breadcrumbs left">
								<li><a href="loginform"><s:text name="Dashboard" /></a></li>
								<li><a href="#"><s:text name="Text.Report.Management" /></a></li>
								<li class="active"><s:text name="Text.report.society" /></li>

							</ol>
							<div class="right" id="xlspdfdownload">
							<a
							onclick="getencriptedData('<s:text name="socialindia.societyReportXLS"/>');">
							<button id="addaccountbuttonid" class="<s:text name="button.color.new.create"/>"
								...
								<a
									onclick="getencriptedData('<s:text name="socialindia.societyReportPDF"/>');">
						...
						<table id="example" class="responsive-table display hoverable" cellspacing="0" width="100%">
							<thead>
								<tr class="<s:text name="datatable.heading.bgcolor"/>">
													...
													<th><s:text name="Text.Form.SocietyId" /></th>
													<th><s:text name="Text.customerreg.activation.key"/></th>
									 ...
									 <th><s:text name="Text.modifyDate"/></th>
								</tr>
							</thead>
						</table>
					</div>
	...
	var oTable;
		...
		function createoTable() {
			...
			oTable = $('#example').DataTable({
								...
								"serverSide" : true,
								"displayLength" : 10,
								"ajaxSource" : "societymgmtReportTbldata?fromdate=" + fromdate + "&todate=" + todate,
								"sorting" : [],
			...
			if(fromdate!='' && todate!=''){
			    ...
			    if (fromdatebj  <= toDateobj) {			    	  			    	   
					...
					oTable = $('#example').DataTable({
										...
										"serverSide" : true,
										"displayLength" : 10,
										"ajaxSource" : "societymgmtReportTbldata?fromdate="
