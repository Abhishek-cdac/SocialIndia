				...
				<div class="container">
					<div class="row">
						<div class="col s12 m12 l12">
							<h5 class="breadcrumbs-title"><s:text name="Text.report.township" /></h5>
							<ol class="breadcrumbs left">
								<li><a href="loginform"><s:text name="Text.Home" /></a></li>
								<li><a href="#"><s:text name="Text.Report.Management" /></a></li>
								<li class="active"><s:text name="Text.report.township" /></li>

							</ol>
							<div class="right" id="xlspdfdownload">
							<a
							onclick="getencriptedData('<s:text name="socialindia.townshipReportXLS"/>');">
							<button id="addaccountbuttonid" class="<s:text name="button.color.new.create"/>"
								...
								<a
									onclick="getencriptedData('<s:text name="socialindia.townshipReportPDF"/>');">
					...
					.DataTable(
							{
								...
								"serverSide" : true,
								"displayLength" : 10,
								"ajaxSource" : "townshipmgmtReportTbldata?fromdate="
					...
					oTable = $('#example').dataTable(
									{
										...
										"serverSide" : true,
										"displayLength" : 10,
										"ajaxSource" : "townshipmgmtReportTbldata?fromdate="+ fromdate + "&todate=" + todate,
										"sorting" : [],
										"paginationType" : "full_numbers",
										"columnDefs" : [ {
											"sortable" : false,
