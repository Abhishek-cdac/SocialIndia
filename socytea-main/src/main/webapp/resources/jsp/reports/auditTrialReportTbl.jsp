				...
				<div class="container">
					<div class="row">
						<div class="col s12 m12 l12">
							<h5 class="breadcrumbs-title"><s:text name="Text.Audit.Trial" /></h5>
							...
							<button id="addaccountbuttonid" class="<s:text name="button.color.new.create"/>"
								...
								<a onclick="getencriptedData('<s:text name="socialindia.auditTrialReportPDF"/>');">
	...
	$('#societyId_txt_id').blur(function(){				
		...
		function getencriptedData(purl){
			...
			$.ajax({
				...
				data : 'fromdate=' + fromdate+'&todate='+todate+"&sSoctyId="+sSoctyId+"&sTowshipId="+sTowshipId,
