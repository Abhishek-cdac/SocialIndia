    ...
    <div class="wrapper">
     <jsp:include page="../common/menuBar.jsp"></jsp:include>
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><s:text name="Breadcrumb.cybrpltrecon" /></h5>
                <ol class="breadcrumbs left">
                  <li><a href="loginform"><s:text name="Breadcrumb.dashboard" /></a></li>
							<li><a href="#"><s:text name="Breadcrumb.Reconcile" /></a></li>
							<li class="active"><s:text name="Breadcrumb.cybrpltrecon" /></li>						             
                   </ol>
             
                 <div class="right">
                   		<input type="file"  name="cyberfile"  class="excelfile" id="uploadfile_id" accept=".csv" style="display: none;">
                     	<button type="button" style="" data-position="bottom" data-delay="10" data-tooltip="Upload Cyberplat Reconcile File" class=" <s:text name="button.color.new.create1"/>" data-toggle="modal" data-target="#addnewaccount" onclick="excelUpload();"><i class="mdi-file-file-upload  left"> </i>Upload Reconn File</button>
                     
                      <!-- <a href="createNewresidentform"><button type="button" class="<s:text name="button.color.new.create"/> tooltipped" data-toggle="modal" data-target="#addnewaccount" data-position="bottom" data-delay="<s:text name="material.tooltip.delay"/>" data-tooltip="View Reconcile Result"><i class="mdi-social-person-add left"> </i>View Reconcile Result</button></a> -->	
      ...
      <div style="width: 98%;margin-left: 1%;display: none;" id="card-alert" class="card success usrerralert">
            ...
            <p><i class="mdi-navigation-check"></i> <s:text name="Text.cyberplat.fileupload"></s:text></p>
            </div>
        ...
        <div id="table-datatables" class="padding10px">              
              <div class="row">
				...
				<s:form method="post" id="delgroupform">
					<s:hidden name="flg" value="cyber" id="uniqSocietyId"></s:hidden>
...
<script type="text/javascript">
			...
			var slectfield_hidd_id = $("#slectfield_hidd_id").val();
			 oTable.destroy();	
			 	oTable = $('#example').DataTable({
						...
						"serverSide" : true,
						"displayLength" : 10,
								"ajaxSource" :"cyberplatemgmttbl?searchWord="+ searchWord+"&townShipId="+townshipid+"&societyId="+societyid+"&slectfield="+slectfield_hidd_id,					
									"sorting" : [],
									"paginationType" : "full_numbers",
									"columnDefs" : [ {
										"sortable" : false,
 ...
 function deletepaygate(id) {
		swal({    title: "Are you sure want to delete?",
         ...
         function(){ 
         	$("#materialid").val(id);
				$("#delgroupform").attr("action", "deletepaycyberplate");
				$("#delgroupform").submit();
