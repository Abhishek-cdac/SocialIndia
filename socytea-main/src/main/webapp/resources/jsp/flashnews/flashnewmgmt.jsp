          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><s:text name="Text.Utility.Management.flashnews" /></h5>
                <ol class="breadcrumbs left">
					...
					<li class="active"><s:text name="Text.Utility.Management.flashnews" /></li>						             
                   </ol>
             
                 <div class="right">
                   		 <a href="newflashnew"><button type="button" class=" <s:text name="button.color.new.create"/>" data-toggle="modal" data-target="#addnewaccount" data-position="bottom" data-delay="<s:text name="material.tooltip.delay"/>" data-tooltip="New Flash News"><i class="mdi-social-public left"> </i>New Flash News</button></a>	
                </div>                                       					
              </div>              
            </div>            
          </div>          
       ...
       <div class="col s12 m4 l3 ">
                <div class="row">
					...
					<s:hidden name="townshipid" id="township_hidd_id"  cssClass="form-control " value="0" /> --%>
						...
						<s:textfield name="societyNames" id="societyId_txt_id" cssClass="typeahead tt-query  form-control"  autocomplete="off" spellcheck="false" />
						<s:hidden id="societyId_hidd_id" name="societyIds" cssClass="form-control"/>
						</div>	 				
					</s:if>
					<div class="input-field col s2">
                ...
                <div class="col s12">
                  <table id="example" class="responsive-table display hoverable" >
                   <thead>
						...
						<th ><s:text name="Images"></s:text></th>
						<th ><s:text name="Flash News Title"></s:text></th>
						<th ><s:text name="Expiry Date"></s:text></th>
  ...
  <!-- END MAIN -->	
	...
	function getsociety_auto(tempdata){
		 ...
		 function selectfieldfun(){
			...
			var locval = [{"id":"","label":"All"},{"id":"1","label":"News Content"},{"id":"2","label":"Expiry Date"}];				
			 ...
			 oTable.destroy();				
			 	oTable = $('#example')
					.DataTable({
						...
						"serverSide" : true,
						"displayLength" : 10,
								"ajaxSource" :"flashnewsmgmt?searchWord="+ searchWord+"&townShipId="+townshipid+"&societyId="+societyid+"&slectfield="+slectfield_hidd_id,					
									"sorting" : [],
									"paginationType" : "full_numbers",
									"columnDefs" : [ {
										"sortable" : false,
		...
		function viewflashnews(id) {
			$("#flashId").val(id);		
			$("#delgroupform").attr("action", "viewflashnews");
			$("#delgroupform").submit();
		}	
		function editflashnews(id){
			$("#flashId").val(id);		
			$("#delgroupform").attr("action", "modifyflashnews");
			$("#delgroupform").submit();
		}
		 function deleteflashnews(id) {
				swal({    title: "Are you sure want to delete?",
		         text: "You will not be able to recover this flash news!",   
		         type: "warning",   
		         ...
		         function(){ 
		         	$("#flashId").val(id);
						$("#delgroupform").attr("action", "deleteflashnew");
						$("#delgroupform").submit();
