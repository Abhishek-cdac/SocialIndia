...
<!-- Start Page Loading -->
					...
					<div class="container">			
						<div class="row">
							<div class="col s12 m12 l12">
								<h5 class="breadcrumbs-title"><s:text name="New Flash News" /></h5>
							...
							<li class="active"><s:text name="New Flash News" /></li>	
						</ol>
					</div>
				</div>
				</div>
				...
				<div id="jqueryvalidation" class="section">
				 ...
				 <form role="form" id="flashnewform"  method="post" action="" enctype="multipart/form-data">
							...
							<div class="row">
            								...
            								<input id="timepickerstarttime" type="text" name="extime" class="form-control input-small evestarttime left"/>
										...
										<div class="input-field col s6">
											<label for="title">Flash News Title<span class="mandatory">*</span></label>
											<s:textfield cssClass="form-control title" name="title" id="title"></s:textfield>
										</div>
									</div> 
								 <div class="row">
								<div class="input-field col s12">
									<label for="flashnewcontent" class="control-label"><s:text name="Text.Utility.Management.flashnewcontent"/><span class="mandatory">*</span></label>
									<textarea class="materialize-textarea validate" name="flashnewcontent" id="flashnewcontent" rows="2" style="resize:none;height: 50px;"></textarea>
								</div>
								</div> 
								 <div class="row">
								<div class="input-field col s12" id="excelformdiv">                               														
								<label for="maintexcelfile" class="control-label lablenames active"><s:text name="Image"/></label>
								<div class="clear height10px"></div>
								<input type="file" id="flashnewimage"  name="flashnewimage" data-maxfilesize="<s:text name="upload.file.size" />"
								class="mrgnleft15 flashnewimage dropify" style="margin-left: 0px;" />
										<div class ="clear height10px"></div>	
								<div id="flashnewimage-error" class="error manualscriptvalidation" style="display: none;">Flash News Image Need.</div>														
								<div class ="clear height25px"></div>	
								</div>	
									 </div> 
								<div class="row">
								<div class="input-field col s6">
								<button type="button" id="userEditButtonId" onclick="createFlashnews();" class="<s:text name="button.color.submit"/>"  ><s:text name="Text.button.submit" /><i class="<s:text name="button.icon.submitcard"/>"></i></button>
    ...
    Scripts
    ================================================ -->
    <link type="text/css" rel="stylesheet" href="<s:text name='Resource.path'/>/css/drop_uploader.css?h" />
	...
	<script type="text/javascript" src="<s:text name='Resource.path'/>/js/drop_uploader.js?hg"></script>
	<script type="text/javascript" src="<s:text name='Resource.path'/>/js/plugins/dropify/js/dropify.min.js?hgjhg"></script>	
...
if (pvrLoginusrsoctyid=="-1" || pvrLoginusrsoctyid=="null" || pvrLoginusrsoctyid=="") {
	...
	$("#title").rules("add", {
		required : true,
		messages : {
			required :"<s:text name="Error.title.titlecontent" />",
		}	
	});
