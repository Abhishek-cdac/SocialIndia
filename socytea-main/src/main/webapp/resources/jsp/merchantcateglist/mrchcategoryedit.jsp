      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"><s:text name="Text.mechnt.modfy.catg"/></h5>
                <ol class="breadcrumbs left">
                   ...
                   <li><a href="posthomepage"><s:text name="Text.Home" /></a></li>
									...
									<li class="active"><s:text name="Text.mechnt.modfy.catg" /></li>               
                   </ol>                              						
              </div>
       	...
       	<div class="card-panel">
										<form  id="userCreationFormId" name="labourEditSubmit" action="mrchcategoryeditSubmitaction" method="post"  enctype="multipart/form-data" >
		...
		<div id="profilehidden" style="display:block;">
			<div class="row">									
           		<div class="col s12">									
					<div class="row">
  									<div class="input-field col s12">
										...
										<s:textfield name="mrchcategoryobj.mrchCategoryName" id="name" cssClass="form-control firstnamevalidate"/> 															
									</div>
 					...
 					<div class="row">	
											...
											<div class="row">
  														   <div class="input-field col s12">
																...
																<s:textarea cssClass="materialize-textarea descriptionid" id="descriptionid" rows="3" cols="" name="mrchcategoryobj.desc"/>													
															</div>		 
 											</div>	
											</div>
										</div>
 					<div class="row">	
						<div class="input-field col s12">
							<div id="documentfiledivid">
								...
								<input type="file" name="staffImage" id="staffImage" class="dropify" data-default-file="/templogo/Mrchcategory/web/<s:property value="#session.MrchcategorySessID"/>/<s:property value="#session.staffProfileImage" />" />	
							</div>
						</div>
					</div>
			</div>
				...
				<s:hidden name="mrchcategoryobj.mrchCategoryId" id="deletelaboridEdit"></s:hidden>			
