	...
	<div id="main">
		...
		<div class="wrapper">
					...
					<div class="container">
						<div class="row">
							<div class="col s12 m12 l12">
								<h5 class="breadcrumbs-title">eNews Modify</h5>
							...
							<li><a href="eNewsmgmt"><s:text name="eNews" /></a></li>
									<li class="active">eNews Modify</li>
								</ol>
							</div>
						</div>
					</div>
			...
			<div class="card-panel">
										<form role="form" id="eNewform"  method="post" enctype="multipart/form-data" action="eNewsupdateaction" >
											  <div class="row rowmargin12px" >
										                <div class="input-field col s6">
																<label for="eNewtitle"><s:text name="Text.title"/><span class="mandatory">*</span></label>															
																 															
															<s:textfield cssClass="form-control emailvalidate" name="eNewsobj.ivrBnTITLE" id="eNewtitle" ></s:textfield>
															</div>							
											
											<div class="input-field col s6">
												<label class=" control-label" for="complaintsTitle"><s:text name="Text.Utility.Management.eventshort" /></label>
												<s:textfield cssClass="form-control subjectvalidate" name="eNewsobj.ivrBnSHRTDESCRIPTION" 
												...
												<s:textarea id="complaintsDesc" name="eNewsobj.ivrBnDESCRIPTION" cssClass=" materialize-textarea form-control custom-control" style="height: 10px;"></s:textarea>   
								...
								<div class="input-field col s12">
									<label class="active"><s:text
											name="File" /></label><span class="atag"> (<s:text name="Text.filesize" />, <s:text name="Text.allowformatfiles"/>)</span>
							...
							class="mrgnleft15 tooltipster documentfile" style="margin-left: 0px;" title="Choose File" accept="image/*" multiple/>
							   <div id="documentfile-error" class="error manualscriptvalidation" style="display: none;">Actual Price Is Required</div>
						          ...
						          <div style="margin-left: 0px;">
										...
										<s:hidden id="eNewid" name="eNewsobj.ivrBnENEWS_ID" ></s:hidden>
											</form>
														</div>
