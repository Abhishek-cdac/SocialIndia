$(function() {
      ...
      var latlng = new google.maps.LatLng(19.06148, 72.88293); // Set your Lat. Log. New York
      var settings = {
          zoom: 10,
          center: latlng,
      ...
      var companyImage = new google.maps.MarkerImage('resources/images/map-marker.png',
          new google.maps.Size(36,62),// Width and height of the marker
          new google.maps.Point(0,0),
          new google.maps.Point(18,52)// Position of the marker 
      );

      var companyPos = new google.maps.LatLng(19.06148, 72.88293);
