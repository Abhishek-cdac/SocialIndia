...
var data = {
	labels : ["Society1","Society2","Society3","Society4","Society5","Society6","Society7"],
	datasets : [
		{
			label: "First dataset",
...
window.onload = function(){
	...
	window.trendingLineChart = new Chart(trendingLineChart).Line(data, {		
		...
		if(document.getElementById("trending-bar-chart") != undefined){
		...
		if(document.getElementById("trending-radar-chart") != undefined){
